...
// taken from https://github.com/dotnet/eShop
public partial class ValueObjectTests
{
    [Theory]
    [MemberData(nameof(EqualValueObjects))]
    public void EqualsEqualValueObjects(ValueObject instanceA, ValueObject instanceB, string reason)
    {
        // Act
    ...
    public void EqualsNonEqualValueObjects(ValueObject instanceA, ValueObject instanceB, string reason)
    {
        // Act
        var result = EqualityComparer<ValueObject>.Default.Equals(instanceA, instanceB);
